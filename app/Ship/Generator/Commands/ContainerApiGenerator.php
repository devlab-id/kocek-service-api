...
class ContainerApiGenerator extends GeneratorCommand implements ComponentsGenerator
{
     ...
     * @var string
     */
    protected $name = 'kocek:generate:container:api';
    /**
     * The console command description.
     *
     * @var string
     */
    protected $description = 'Create a Container for Kocek from scratch (API Part)';
    /**
    ...
    public function getUserInputs(): array|null
    {
        ...
        $this->call('kocek:generate:readme', [
            '--section' => $sectionName,
        ...
        $this->call('kocek:generate:configuration', [
            '--section' => $sectionName,
            '--container' => $containerName,
        ...
        $this->call('kocek:generate:provider', [
            '--section' => $sectionName,
            '--container' => $containerName,
        ...
        $this->call('kocek:generate:model', [
            '--section' => $sectionName,
            '--container' => $containerName,
            '--file' => $model,
            '--repository' => true,
        ...
        $this->call('kocek:generate:migration', [
            '--section' => $sectionName,
            '--container' => $containerName,
        ...
        $this->call('kocek:generate:transformer', [
            '--section' => $sectionName,
            '--container' => $containerName,
        ...
        $this->call('kocek:generate:factory', [
            '--section' => $sectionName,
            '--container' => $containerName,
        ...
        foreach ($routes as $route) {
            $this->call('kocek:generate:request', [
                '--section' => $sectionName,
                '--container' => $containerName,
                '--file' => $route['request'],
                '--ui' => $ui,
            ...
            $this->call('kocek:generate:action', [
                '--section' => $sectionName,
                '--container' => $containerName,
                '--file' => $route['action'],
                '--ui' => $ui,
            ...
            if ($generateEvents) {
                $this->call('kocek:generate:event', [
                    '--section' => $sectionName,
                    '--container' => $containerName,
                    '--file' => $route['event'],
                    '--model' => $model,
            ...
            if ($generateTests) {
                $this->call('kocek:generate:test:unit', [
                    '--section' => $sectionName,
                    '--container' => $containerName,
                    '--file' => $route['unittest'],
                    '--model' => $model,
                ...
                $this->call('kocek:generate:test:functional', [
                    '--section' => $sectionName,
                    '--container' => $containerName,
            ...
            if ('sac' === $controllertype) {
                $this->call('kocek:generate:route', [
                    '--section' => $sectionName,
                    '--container' => $containerName,
                    '--file' => $route['name'],
                    '--ui' => $ui,
                ...
                $this->call('kocek:generate:controller', [
                    '--section' => $sectionName,
                    '--container' => $containerName,
