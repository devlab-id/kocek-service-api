...
class ContainerGenerator extends GeneratorCommand implements ComponentsGenerator
{
     ...
     * @var string
     */
    protected $name = 'kocek:generate:container';
    /**
     * The console command description.
     *
     * @var string
     */
    protected $description = 'Create a Container for Kocek from scratch';
    /**
    ...
    public function getUserInputs(): array|null
    {
        ...
        if ('api' === $ui || 'both' === $ui) {
            $this->call('kocek:generate:container:api', [
                '--section' => $sectionName,
        ...
        if ('web' === $ui || 'both' === $ui) {
            $this->call('kocek:generate:container:web', [
                '--section' => $sectionName,
                '--container' => $containerName,
                '--file' => 'composer',
                '--maincalled' => true,
