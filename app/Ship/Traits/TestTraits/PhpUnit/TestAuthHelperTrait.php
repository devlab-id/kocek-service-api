...
namespace App\Ship\Traits\TestTraits\PhpUnit;
...
trait TestAuthHelperTrait
{
    ...
    public function getTestingUser(array|null $userDetails = null, array|null $access = null, bool $createUserAsAdmin = false): UserModel
    {
        ...
        $this->userClass = $this->userclass ?? Config::get('kocek.tests.user-class');
        $this->userAdminState = Config::get('kocek.tests.user-admin-state');
